...
export const Route = createFileRoute('/carbon-quiz')({
  component: CarbonQuizPage,
})

function CarbonQuizPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-green-50 to-blue-50 px-4 py-8 flex items-center justify-center">
